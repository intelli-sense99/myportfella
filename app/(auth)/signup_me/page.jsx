        ...
        <div className="min-h-screen flex items-center justify-center py-12 px-3 lg:px-4 relative overflow-hidden">
            ...
            <div className="max-w-md w-full relative z-10">
                        ...
                        <div>
                            <label className="flex items-start gap-3 cursor-pointer">
                                ...
                                <span className="text-sm text-[var(--text-secondary)]">
                                    I agree to the{' '}
                                    <Link href="/terms" className="text-[var(--accent-primary)] hover:text-[var(--accent-secondary)] transition-colors cursor-pointer">
                                        Terms of Service
                                    </Link>
                                    {' '}and{' '}
                                    <Link href="/privacy" className="text-[var(--accent-primary)] hover:text-[var(--accent-secondary)] transition-colors cursor-pointer">
                                        Privacy Policy
                                    </Link>
                                </span>
                            </label>
                ...
                <div className="text-center mt-4">
                    <Link href="/" className="text-sm text-[var(--muted)] hover:text-[var(--accent-primary)] transition-colors inline-flex items-center gap-2 cursor-pointer">
