  ...
  return (
    <section id="hero" className="min-h-[calc(100vh-4rem)] flex items-center pt-16 pb-12 relative overflow-hidden">
      ...
      <div
        ...
        style={{
          background: `radial-gradient(circle 600px at ${mousePosition.x}% ${mousePosition.y}%, rgba(229, 9, 20, 0.15) 0%, rgba(131, 16, 16, 0.1) 30%, transparent 70%)`,
      ...
      <div
        ...
        style={{
          ...
          background: 'radial-gradient(circle, rgba(229, 9, 20, 0.2) 0%, rgba(131, 16, 16, 0.15) 40%, transparent 70%)',
          filter: 'blur(60px)',
        ...
        <div className="w-full grid md:grid-cols-2 gap-8 items-center relative z-10">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-4 pt-4">
              <a href="#" className="w-10 h-10 rounded-lg bg-[var(--card-bg)] border border-[var(--card-border)] flex items-center justify-center hover:border-[var(--accent-primary)] hover:scale-110 transition-all duration-300 cursor-pointer">
